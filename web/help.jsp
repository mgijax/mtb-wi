...
<jax:mmhcpage title="Help">
	...
	<jsp:body>	
		<section class="container content">
			...
			<ul>
				<li>Have data on mouse models of human cancer you'd like to submit?</li>
				<li>Can't find the mouse model you're looking for?</li>
				<li>Found an error in our database?</li>
				<li>Are we missing your publication on a mouse model of cancer?</li>
				<li>Need a special database report?</li>
				<li>Have a complaint or suggestion?</li>
			</ul>
