			...
			<td>
				<table>
					<tr>
						...
						<td><strong>Entering human gene symbols, names or Entrez IDs returns a list of orthologous mouse symbols and associated data.</strong> Entrez ID searches must use 'equals'.</td>
