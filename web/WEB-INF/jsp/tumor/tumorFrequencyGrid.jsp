                    ...
                    <c:forEach var="organParent" items="${anatomicalSystem.organs}" varStatus="status">
                        ...
                        <c:choose>
                            <c:when test="${not empty organKey}">
                                 <c:choose>
                                        ...
                                        <c:forEach var="organ" items="${organParent.organs}" varStatus="status">
                                            ...
                                            <c:choose>
                                                <c:when test="${organ.organKey == organKey}">
                                                    ...
                                                    <%--
                                                    <th><a href="${redirectUrl}"><img src="${applicationScope.urlImageDir}/grid/${organParent.organKey}.png" border="0"></a><br><br><a href="${redirectUrl}"><img src="${applicationScope.urlImageDir}/gridCollapse.png" border="0"></a><br></th>
                                                    --%>
                                                    <th><a href="${redirectUrl}"><img src="${applicationScope.urlImageDir}/grid/${organParent.organKey}.png" border="0" alt="X"></a><br><a href="${redirectUrl}"><img src="${applicationScope.urlImageDir}/grid/grid_col_top.png" border="0" alt="-"></a><br></th>
                                                </c:when>
                                                <c:otherwise>
                                    ...
                                    <c:otherwise>
                                        ...
                                        <%--
                                        <th><a href="${redirectUrl}"><img src="${applicationScope.urlImageDir}/grid/${organParent.organKey}.png" border="0"></a><br><br><a href="${redirectUrl}"><img src="${applicationScope.urlImageDir}/gridExpand.png" border="0"></a><br></th>
                                        --%>
                                        <c:choose>
                                            <c:when test="${fn:length(organParent.organs) == 1}">
                                                <th><img src="${applicationScope.urlImageDir}/grid/${organParent.organKey}.png" border="0" alt="X"><br><img src="${applicationScope.urlImageDir}/grid/grid_spacer.png" border="0" alt=" "><br></th>
                                            </c:when>
                                            <c:otherwise>
                                                <th><a href="${redirectUrl}"><img src="${applicationScope.urlImageDir}/grid/${organParent.organKey}.png" border="0" alt="X"></a><br><a href="${redirectUrl}"><img src="${applicationScope.urlImageDir}/grid/grid_exp_top.png" border="0" alt="+"></a><br></th>
                                            </c:otherwise>
                                        </c:choose>
                                    </c:otherwise>
                                </c:choose>
                            ...
                            <c:otherwise>
                                ...
                                <%--
                                <th valign="bottom"><a href="${redirectUrl}"><img src="${applicationScope.urlImageDir}/grid/${organParent.organKey}.png" border="0"></a><br><a href="${redirectUrl}"><img src="${applicationScope.urlImageDir}/gridExpand.png" border="0"></a></th>
                                --%>
                                <c:choose>
                                    <c:when test="${fn:length(organParent.organs) == 1}">
                                        <th valign="bottom"><img src="${applicationScope.urlImageDir}/grid/${organParent.organKey}.png" border="0" alt="X"><br><img src="${applicationScope.urlImageDir}/grid/grid_spacer.png" border="0" alt=" "></th>
                                    </c:when>
                                    <c:otherwise>
                                        <th valign="bottom"><a href="${redirectUrl}"><img src="${applicationScope.urlImageDir}/grid/${organParent.organKey}.png" border="0" alt="X"></a><br><a href="${redirectUrl}"><img src="${applicationScope.urlImageDir}/grid/grid_exp_top.png" border="0" alt="+"></a></th>
                                    </c:otherwise>
                                </c:choose>
                            </c:otherwise>
                        </c:choose>
                    ...
                    <c:forEach var="heredityItem" items="${gridData}" varStatus="status2">
                        <c:if test="${empty heredityGrid}">
                            <c:if test="${heredityItem.value.strainHeredityKey == rowHeredity.strainHeredityKey}">
                                <%--MATCH: heredityItem.value.strainHeredityKey == rowHeredity.strainHeredityKey<br>--%>
                                <%--MATCH: ${heredityItem.value.strainHeredityKey} == ${rowHeredity.strainHeredityKey}<br>--%>
                            ...
                            <c:forEach var="fam" items="${heredityAll.families}" varStatus="status3">
                                ...
                                <c:if test="${!status3.first}">
                                    ...
                                    <c:forEach var="familyItem" items="${heredityGrid.strainFamilies}" varStatus="status3">
                                        ...
                                        <c:if test="${familyItem.value.strainFamilyKey == fam.strainFamilyKey}">
                                            <%--MATCH: familyItem.value.strainFamilyKey == fam.strainFamilyKey<br>
                                            MATCH: ${familyItem.value.strainFamilyKey} == ${fam.strainFamilyKey}<br>--%>
                                ...
                                <c:choose>
                                    <c:when test="${not empty familyGrid}">
                                        ...
                                        --%>
                                        <%--We have a family value. <b>${familyGrid.strainFamilyName}</b><br>--%>
                                        <c:url var="redirectUrl" value="redirect.do">
                                            ...
                                            <c:when test="${not empty strainFamilyKey}">
                                                <c:choose>
                                                    <c:when test="${fam.strainFamilyKey == strainFamilyKey}">
                                                        <%--
                                                        <td class="grid"><a href="${redirectUrl}"><img src="${applicationScope.urlImageDir}/gridCollapse.png" border="0"></a>&nbsp;&nbsp;${familyGrid.strainFamilyName} (ALL)</td>
                                                        --%>
                                                        <td class="grid"><a href="${redirectUrl}"><img src="${applicationScope.urlImageDir}/grid/grid_col_left.png" border="0" alt="-"></a>&nbsp;${familyGrid.strainFamilyName} (ALL)</td>
                                                    </c:when>
                                                    <c:otherwise>
                                                        <%--
                                                        <td class="grid"><a href="${redirectUrl}"><img src="${applicationScope.urlImageDir}/gridExpand.png" border="0"></a>&nbsp;&nbsp;${familyGrid.strainFamilyName}</td>
                                                        --%>
                                                        <td class="grid"><a href="${redirectUrl}"><img src="${applicationScope.urlImageDir}/grid/grid_exp_left.png" border="0" alt="+"></a>&nbsp;${familyGrid.strainFamilyName}</td>
                                                    </c:otherwise>
                                                </c:choose>
                                            </c:when>
                                            <c:otherwise>
                                                            ...
                                                            <c:forEach var="organParent" items="${anatomicalSystem.organs}" varStatus="status">
                                                                ...
                                                                <c:choose>
                                                                    <c:when test="${not empty organKey}">
                                                                        ...
                                                                        <h3>TESTING</h3>
                                                                        ORGAN KEY = ${organKey}<br>
                                                                        ORGAN PARENT KEY = ${organParent.organKey}<br>
                                                                        --%>
                                                                        <c:choose>
                                                                            <c:when test="${organKey == organParent.organKey}">
                                                                                    ...
                                                                                    <c:forEach var="organItem" items="${familyGrid.organs}" varStatus="status">
                                                                                        <c:forEach var="subOrganItem" items="${organItem.value.organs}" varStatus="status">
                                                                                            <c:if test="${subOrgan.organKey == subOrganItem.value.organKey}">
                                                                                                <%--
                                                                                                MATCH: ${subOrgan.organKey} == ${subOrganItem.value.organKey}<br>
                                                                                                ORGAN: ${subOrgan.organName}<br>
                                                                                                --%>
                                                                                    ...
                                                                                    <c:choose>
                                                                                        <c:when test="${not empty organ}">
                                                                                            ...
                                                                                            <c:choose>
                                                                                                ...
                                                                                                <c:otherwise>
                                                                                                    <c:set var="tdOut" value="<img src='${applicationScope.urlImageDir}/grid/${organ.frequencyDetail.descriptionHighest}.png' border='0' alt='-'>"/>
                                                                                                </c:otherwise>
                                                                                            </c:choose>
                                                                                            <%--
                                                                            ...
                                                                            <c:otherwise>
                                                                                ...
                                                                                <c:forEach var="organItem" items="${familyGrid.organs}" varStatus="status4">
                                                                                    <c:if test="${organParent.organKey == organItem.value.organKey}">
                                                                                        <%--MATCH: ${organParent.organKey} == ${organItem.value.organKey}<br>
                                                                                        ORGAN: ${organParent.organName}<br>--%>
...
<%----------------------------------- START Strain Expansion -------------------------------------------%>
                                                        <%--
                                                        ${fam.strainFamilyKey} == ${strainFamilyKey}<br>
                                                        DISPLAY SUB STRAINS!<br>
                                                        --%>
                                                        ...
                                                        <c:set var="theStrain" value=""/>
                                                            ...
                                                            <tr class="grid">
                                                            <td class="grid"><img src="${applicationScope.urlImageDir}/grid/grid_spacer.png" border="0" alt=" "><img src="${applicationScope.urlImageDir}/grid/grid_spacer.png" border="0" alt=" "><img src="${applicationScope.urlImageDir}/grid/grid_spacer.png" border="0" alt=" "><c:out value="${strainCat.strainName}" escapeXml="false"/></td>
                                                            <c:choose>
                                                                                            ...
                                                                                            <c:choose>
                                                                                                <c:when test="${not empty organ}">
                                                                                                    ...
                                                                                                    <c:choose>
                                                                                                        ...
                                                                                                        <c:otherwise>
                                                                                                            <c:set var="tdOut" value="<img src='${applicationScope.urlImageDir}/grid/${organ.frequencyDetail.descriptionHighest}.png' border='0' alt='H'>"/>
                                                                                                        </c:otherwise>
                                                                                                    </c:choose>
...
<%----------------------------------- END Strains are not expanded -------------------------------------%>
                                    ...
                                    <c:otherwise>
                                        ...
                                        <td class="grid"><img src="${applicationScope.urlImageDir}/grid/grid_spacer.png" border="0" alt=" ">&nbsp;${fam.strainFamilyName}</td>
                                        <c:set var="startColumn" value="3"/>
                                        <c:if test="${not empty organKey}">
                                            <c:set var="startColumn" value="4"/>
                                        </c:if>
