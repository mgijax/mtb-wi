      ...
      <table width="100%" border=0 cellpadding=0 cellspacing=0>
        <tr>
          <td width="20%" valign="middle" align="left">
            <a class="help" href="userHelp.jsp#dynamicgrid"><img src="${applicationScope.urlImageDir}/help_large.png" border=0 width=32 height=32 style="vertical-align:middle" alt="Help">Help and Documentation</a>
          </td>
  ...
  <c:forEach var="anatomicalSystem" items="${anatomicalSystems}" varStatus="status">
    <c:forEach var="organParent" items="${anatomicalSystem.organs}" varStatus="status">
      ...
      <c:forEach var="organ" items="${organParent.organs}" varStatus="status">
        ...
        <th>
        <img src="${applicationScope.urlImageDir}/grid/${organ.organKey}.png" border="0" alt="X"><br>
...
<c:forEach var="fam" items="${rowHeredity.families}" varStatus="status3">
  ...
  <td class="grid" bgcolor="#ffffff">
    <img src="${applicationScope.urlImageDir}/grid/grid_spacer.png" border="0" alt=" ">&nbsp;${fam.strainFamilyName}
  </td>
