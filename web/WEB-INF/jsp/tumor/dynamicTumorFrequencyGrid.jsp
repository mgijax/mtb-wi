	...
	<table class="grid">
		...
		<tr class="grid">
			...
			<th><a href="javascript: submitFormOrgan(${organ.organKey})"><img src="${applicationScope.urlImageDir}/grid/${organParent.organKey}.png" alt="X"></a>
				...
				<!-- \n -->
			<html:multibox property="organGrpChk" value="${organParent.organKey}" /></th>
			</c:when>
			<c:otherwise>
			...
			<c:otherwise>
			<th><a href="javascript: submitFormOrgan(${organParent.organKey})"><img src="${applicationScope.urlImageDir}/grid/${organParent.organKey}.png" alt="X"></a>
				<!-- \n -->
				<a href="javascript: submitFormOrgan(${organParent.organKey})"><img src="${applicationScope.urlImageDir}/grid/grid_exp_top.png" alt="+"></a>
				<!-- \n -->
			<html:multibox property="organGrpChk" value="${organParent.organKey}" /></th>
			</c:otherwise>
			</c:choose>
			...
			<th><img src="${applicationScope.urlImageDir}/grid/${organParent.organKey}.png" alt="X">
				<!-- \n -->
			<img src="${applicationScope.urlImageDir}/grid/grid_spacer.png" alt=" "><html:multibox property="organGrpChk" value="${organParent.organKey}" /></th>
			</c:when>
			<c:otherwise>
			<th><a href="javascript: submitFormOrgan(${organParent.organKey})"><img src="${applicationScope.urlImageDir}/grid/${organParent.organKey}.png" alt="X"></a>
				<!-- \n -->
				<a href="javascript: submitFormOrgan(${organParent.organKey})"><img src="${applicationScope.urlImageDir}/grid/grid_exp_top.png" alt="+"></a><html:multibox property="organGrpChk" value="${organParent.organKey}" /></th>
			</c:otherwise>
			</c:choose>
			</c:otherwise>
			</c:choose>
		...
		<tr class="grid">
			...
			<tr class="grid">
				...
				<td class="grid"> <span style="white-space:nowrap"><a href="javascript: submitFormStrain(${familyGrid.strainFamilyKey})"><img src="${applicationScope.urlImageDir}/grid/grid_col_left.png" alt="-"></a>&nbsp;${familyGrid.strainFamilyName} (Summary)<html:multibox property="strainFamilyChk" value="${familyGrid.strainFamilyKey}" /></span></td>
				</c:when>
				<c:otherwise>
				<td class="grid"> <span style="white-space:nowrap"><a href="javascript: submitFormStrain(${familyGrid.strainFamilyKey})"><img src="${applicationScope.urlImageDir}/grid/grid_exp_left.png" alt="+"></a>&nbsp;${familyGrid.strainFamilyName}<html:multibox property="strainFamilyChk" value="${familyGrid.strainFamilyKey}" /></span></td>
				</c:otherwise>
				</c:choose>
				</c:when>
				<c:otherwise>
...
<tr class="grid">
	<td class="grid"><span style="white-space:nowrap"><c:out value="${strainCat.strainName}" escapeXml="false"/><img src="${applicationScope.urlImageDir}/grid/grid_spacer.png" alt=" "></span></td>
	<c:choose>
