...
<c:when test="${not empty tumors}">
    <c:set var="lbl" value="1"/>
        <tr class="results">
            <td class="resultsHeader" rowspan="2">Tumor Name</td>
        ...
        <c:forEach var="tumor" items="${tumors}" varStatus="status">
            ...
            <td>
               ...
               <c:when test="${tumor.images==true}">
                 <center><a href="javascript:void(0);" style="text-decoration: none; cursor:help;" onmouseover="return overlib('Images aviable from Pathology Reports link on Summary Page');" onmouseout="return nd();"><img src="${applicationScope.urlImageDir}/pic.gif" alt="X" border="0"></a></center>
               </c:when>
               <c:otherwise>
                   &nbsp;
               </c:otherwise>
