...
<jax:mmhcpage title="Patient Derived Xenograft" subtitle="PDX Information Request Form">
	...
	<section id="summary">
		<div class="container">
			...
			<p>* Designates required information</p>
	...
	<!-- method="GET" -->
	<jax:searchform action="pdxRequest">
							...
							<!-- <form action="pdxRequest.do" method="GET" name="requestForm"> -->
									...
									<!-- 
									 ...
									 -->
										...
										*Verify Email<input type="text" name="vemail" size="30">
										...
										*Organization<input type="select" name="org" size="30">
