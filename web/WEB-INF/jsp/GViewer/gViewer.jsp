...
<jax:mmhcpage title="Cancer QTL Viewer" help="QTL">
	...
	<table>
		...
		<caption>
			<h2>Cancer and Tumorigenesis QTLs</h2>
		</caption>
		<tbody>
			<tr>
				<td colspan="2">
					<a data-tip="Select a type of QTL using a pick list. Ctrl+Click to select more than one.">Select QTL Type(s) to view</a>:
			...
			<tr>
				<td>
					<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,0,0" width="500" height="400" id="GViewer2">
			...
			<tr>
				<td colspan="2">
					<p>Genome coordinates used for the mouse cancer QTL are from NCBI Build 37.</p>
					<p>GViewer software courtesy of <a href="http://rgd.mcw.edu/">RGD</a>.</p>
				</td>
			</tr>
		</tbody>
	</table>
