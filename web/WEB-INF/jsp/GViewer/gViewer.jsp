                  ...
                  <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="20%" valign="middle" align="left">
                        <a class="help" href="userHelp.jsp#QTL"><img src="${applicationScope.urlImageDir}/help_large.png" border=0 width=32 height=32 style="vertical-align:middle" alt="Help">Help and Documentation</a>
                      </td>
...
<!--======================= Start Detail Section ===========================-->
       ...
       <%--       <html:form action="gViewer" method="GET"> --%>
            ...
            <%--            <html:select property="selectedQTLTypes" size="8" multiple="true">
                ...
                <tr>
                  <td colspan="2">Genome coordinates used for the mouse cancer QTL are from NCBI Build 37.<br>
