   ...
   //             }
        ...
        var mgdWin =  new Ext.Window({
            ...
            html: '<form name="mgiForm"><table>'+
                ...
                '</tr>'+
                '<tr class="stripe1"><td class="cat1">Feature Type</td><td colspan="5" id="featureTypeSelection"></td></tr>'+
                '<tr class="stripe2">'+
                '<td class="cat2">'+
                ...
                '</select>'+
                '&nbsp;'+
                '<input type="text" name="goTerm" size="30"/>&nbsp;in<br>'+
                ...
                '</td><td colspan="2">'+
                '<input type="checkbox" name="ontology_key1" value="Molecular+Function"/>Molecular Function<br>'+
                '<input type="checkbox" name="ontology_key2" value="Biological+Process"/>Biological Process<br>'+
            ...
            if(!helpWindow){
                helpWindow = new Ext.Window({
                    ...
                    html:"<p><b>Loading QTLs</b><br>"+
                        ...
                        "&nbsp;	A collapsible legend displays the types of loaded QTL. <br>"+
                        "&nbsp;	In the legend, clicking on a QTL's colored box allows the QTL group's display properties to be configured.<br>"+
                        "</p><p>"+
                        "<b>Zoom in</b><br>"+
                        "&nbsp;	Click and drag on a chromosome to select a region to zoom into.<br>"+
                        "&nbsp;	The zoom panel is then displayed on the right. <br>"+
                        "&nbsp;	The zoomed region corresponds to red highlighted region on the chromosome. <br>"+
                        "&nbsp;	Zoom can be adjusted by dragging red indicator or by the scroll and zoom buttons on zoom panel.<br>"+
                        "</p><p>	"+
                        "<b>Export/Import</b><br>"+
                        "&nbsp;	'File->Load Features' allows features to be loaded from a .gff file.<br>"+
                        "&nbsp;	'File->Export' exports currently displayed features as a .gff file.<br>"+
                        "</p><p>	"+
                        "<b>Capture Image</b><br>"+
                        "&nbsp;	'View->Capture Image' converts viewer display into single image which can be saved.<br>"+
                        "</p><p>	"+
                        "<b>Load From MGI</b><br>"+
                        "&nbsp;	The viewer can be used to query MGI in two ways. <br>"+
                        "&nbsp;	'File->Load annotations from MGI' opens a simple query window. <br>"+
                        "&nbsp;	Results are displayed on the viewer. <br>"+
                        "&nbsp;	Alternatively, clicking on the symbol of a feature in the feature details table opens a new window with a more advanced query form. <br>"+
                        "&nbsp;	Results from this query page can be sent back to the viewer.<br></p>"
                });
            }
            helpWindow.show(); 
        };
        ...
        function gffHowToHandler(){
            if(!howToWindow){
                howToWindow = new Ext.Window({
                    ...
                    plain: true,
                    html:"<pre><br>"+
                       " You can easily upload your own genome features for display in the QTL Viewer using a General Feature Format (GFF) file. <br>"+
                       " The GFF format is a simple tab-delimited text file with the following 9 columns:<br>"+
                       " <br>"+
                       " SEQID - <b>required</b>; chromosome #<br>"+
                       " SOURCE - not used by the viewer; use '.' to indicate an empty field<br>"+
                       " TYPE - not used by the viewer; use '.' to indicate an empty field<br>"+
                       " START - <b>required</b>; start coordinate of the genome feature<br>"+
                       " END - <b>required</b>; end coordinate of the genome feature<br>"+
                       " SCORE - not used by the viewer; use '.' to indicate an empty field <br>"+
                       " STRAND - not used by the viewer; use '.' to indicate an empty field<br>"+
                       " PHASE - not used by the viewer; use '.' to indicate an empty field<br>"+
                       " ATTRIBUTES. -  optional; used to label and format data display in the viewer<br>"+
                       " <br>"+
                       " Information in the ATTRIBUTES field modifies how information is displayed in the viewer. <br>"+
                       " All of these attributes are optional.  <br>"+
                       " The different format is attribute=value with each pair separated by semicolons (;). <br>"+
                       " <br>"+
                       " The accepted attributes are:<br>"+
                       " mgiID - the accession id for a feature from the Mouse Genome Informatics group. No default value.<br>"+
                       " color - the color of the feature to be displayed. Can be the <a href='http://www.december.com/html/spec/color.html' target='_blank'>name of the color or the hex code</a>. Green is default.   <br>"+
                       " track - determines the side of the chromosome for display (L or R); R is default.<br>"+
                       " group - a label for a group of features. No default value.<br>"+
                       " Name - the symbol of the feature. No default value. Attribute name must begin with a capital 'N'.<br>"+
                       " description - the full name for a feature. No default value.<br>"+
                       " <br>"+
                       " Groups as defined by the group attribute(s) are displayed in the legend to the left of the viewer.<br>"+
                       " The legend assumes all members of a group have the same color and track atrributes.<br>"+
                       " If a GFF file has features with the same group but different colors or tracks,<br>"+
                       " the color and track in the legend will be based on an aribitrary feature from the group.<br>"+
                       " Changing the color or track via the legend will affect all features in the group.<br>"+
                       " <br> <a href='http://www.sanger.ac.uk/resources/software/gff/spec.html' target='_blank'>The formal GFF specification can be found here.</a> <br>"+
                       " <br>"+
                       " Here is a sample text file in GFF format.<br>"+
                       " <a href='${applicationScope.gViewerPath}/QTL_viewer_example_file.txt' target='_blank'>QTL_viewer_example_file.txt</a><br>"+
                       " </pre>"
                });
            }
            howToWindow.show(); 
        ...
        <tr>
            <td>
                <table border="0" cellpadding=5 cellspacing=1" width="100%">
                    <tr>
                        <td id="mainDiv" colspan="2" style="width:100%">
                            
                            <noscript>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<h2 align="center">The QTL Viewer requires Javascript which is disabled or unavailable on your browser.</h2></noscript>
                        </td>
                        
                    </tr>
                    <tr>
                        <td>
                            <iframe id="jBrowseFrame" height="500px" width="1349px" style="border: 1px solid #dfdfdf; padding: 5px" src=""></iframe>
                        </td>
                    </tr>
