        ...
        <script type="text/javascript">
            ...
            function queryToUI(queryStr){
                ...
                if(queryStr.indexOf("minFC") != -1){
                    metastatic = document.getElementById("minFC").checked = true;
                }else{
                    metastatic = document.getElementById("minFC").checked = false;
                }
        ...
        <table>
            ...
            <tr>
                <td valign="top">
                    ...
                    <input type="checkbox" id="asCSV" onClick="asCSVCB()">As CSV<br>
                    <br>
                    <b>Active Filters:</b>
