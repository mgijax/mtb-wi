        ...
        <script type="text/javascript">
            ...
            function getStandardArgs() {
                var params = [
                    ...
                    // and this (on mtb3) fq=minFC:[1 TO 1]
                ...
                for(var i=0; i < rsp.response.docs.length; i++){
                    ...
                    if(doc.hasOwnProperty("pathologyImages")){
                        ...
                        if(doc.pathologyImages == 1){
                            html += "&quot; ,&quot; id&quot; ,500,1200);return false;'>"+doc.pathologyImages+" Pathology Image</a><br>";   
                        }else{
                            html += "&quot; ,&quot; id&quot; ,500,1200);return false;'>"+doc.pathologyImages+" Pathology Images</a><br>";
                        }
                    }
                    ...
                    if(doc.hasOwnProperty("cytoImages")){
                        ...
                        if(doc.cytoCount== 1){
                            html += "&quot; ,&quot; id&quot; ,500,1200);return false;'>1 Cytogenetic Image</a><br>";
                        }else{
                            html += "&quot; ,&quot; id&quot; ,500,1200);return false;'>"+doc.cytoCount+" Cytogenetic Images</a><br>";
                        }
                    }
                    if(doc.geneExpression){
                        ...
                        html += "&quot; ,&quot; id&quot; ,500,1200);return false;'>Gene Expression Data</a><br>";
