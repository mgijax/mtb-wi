...
public class PathologyImageSearchResultsAction extends Action {
    ...
    private final static Logger log =
            org.apache.logging.log4j.LogManager.getLogger(PathologyImageSearchResultsAction.class.getName());
    ...
    public ActionForward execute(ActionMapping mapping,
        ...
        if (tfKeys == null || tfKeys.length()==0) {
            ...
            Map<String,LabelValueBean<String,String>> mapMethods = null;
                //WIConstants.getInstance().getMethods();
            if(false && mapMethods.get(strMethod)!=null){
                //method is valid
            }else{
                strMethod = null;
            }
